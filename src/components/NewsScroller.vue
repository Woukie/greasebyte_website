...
const text = [
  ...
  `Applicants must be smart, curious, and highly motivated self-starters, who demonstrate a passion for the asset management industry and Vanguard's mission to improve outcomes for all investors. Assessment for the role will include an online psychometric test followed by a skills assessment and two rounds of interviews.`,
  ...
  `The First at Fendi Program aims to welcome the New Generation of Talents by offering them a disruptive experience within the Fendi Family in a context of fast pace.`,
